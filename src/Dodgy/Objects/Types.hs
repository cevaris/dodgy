...
makeMapOne = MapOne {
  brickMap = [
     ...
     makeBrick (25,(-1),(-1)) WideBrick,
     makeBrick (25,1,(-1)) LongBrick,
     makeBrick (26,0,0) WideBrick,
     makeBrick (28,0,0) LongBrick,
     makeBrick (28,1,1) UnitBrick,
     makeBrick (29,(-1),1) WideBrick,
     makeBrick (30,0,0) SpecialBrick,
